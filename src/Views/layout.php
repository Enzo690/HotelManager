...
<div class="wrapper">
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark"><?php
                            ...
                            echo $title === "Index" ? "Accueil" : $title ;
                            ?></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <div class="content">
            <div class="container-fluid">
                <?php include '../src/Views/componant/header.php' ?>

                <main>
                    <?php echo $content; ?>
                </main>

                <?php include '../src/Views/componant/footer.php' ?>
            </div><!-- /.container-fluid -->
        </div>
        <!-- /.content -->
    </div>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2014-2019 <a href="https://www.youtube.com/watch?v=CDW2ReQZOQU">Hotel Manager</a>.</strong> All rights reserved.
    </footer>
</div>
